...
df.drop(['QQQ'], inplace=True, axis=1)

df.to_excel('data_2310040045.xlsx')

"""

#df = yf.Ticker('SPY').history(start="2023-09-20", end="2023-09-25")

#df = yf.download('SPY', start="2023-09-20", end="2023-09-25")
